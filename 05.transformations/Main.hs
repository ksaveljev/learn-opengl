...
mainLoop window shaderProgram vao containerTexture awesomefaceTexture = do
    ...
    unless closeFlag $ do
      ...
      asUniform transform $ getUniform shaderProgram "transform"
...
main = do
    ...
    case mw of
      ...
      Just window -> do
        ...
        shaderProgram <- simpleShaderProgram "05.transformations/simple.vs" "05.transformations/simple.fs"
        ...
        -- Texture 1
        Right containerTexture <- readTexture "05.transformations/container.jpg"
        ...
        -- Texture 2
        Right awesomefaceTexture <- readTexture "05.transformations/awesomeface.png"
        textureFilter   Texture2D   $= ((Linear', Nothing), Linear')
        textureWrapMode Texture2D S $= (Repeated, Repeat)
        textureWrapMode Texture2D T $= (Repeated, Repeat)
        generateMipmap Texture2D $= Enabled
