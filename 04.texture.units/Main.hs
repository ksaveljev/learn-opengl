...
main = do
    ...
    case mw of
      ...
      Just window -> do
        ...
        shaderProgram <- simpleShaderProgram "04.texture.units/simple.vs" "04.texture.units/simple.fs"
        ...
        -- Texture 1
        Right containerTexture <- readTexture "04.texture.units/container.jpg"
        ...
        -- Texture 2
        Right awesomefaceTexture <- readTexture "04.texture.units/awesomeface.png"
        textureFilter   Texture2D   $= ((Linear', Nothing), Linear')
        textureWrapMode Texture2D S $= (Repeated, Repeat)
        textureWrapMode Texture2D T $= (Repeated, Repeat)
        generateMipmap Texture2D $= Enabled
